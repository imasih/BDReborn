...
if is_banned(data.id_, arg.chat_id) then
   if not lang then
		tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "#Done *Member with :*\n*Username* : "..user_name.."\nid : *"..data.id_.."*\n*is Ban*", 0, "md")
   else
...
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "#Done *Member with :*\n*Username* : "..user_name.."\nid : *"..data.id_.."*\n*Already Ban*", 0, "md")
   else
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* `Not` *Ban*", 0, "md")
   else
...
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
   if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* `Not` *Silent*", 0, "md")
   else
...
if not is_gbanned(data.id_) then
   if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "*User* `Not` *globally banned*", 0, "md")
   else
  ...
  administration['gban_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
    if not lang then
     return tdcli.sendMessage(arg.chat_id, "", 0, "#Done *Member with :*\n*Username* : "..user_name.."\nid : *"..data.id_.."*Has Been globally unbanned*", 0, "md")
   else
...
tdcli.deleteMessagesFromUser(data.chat_id_, data.sender_user_id_, dl_cb, nil)
   if not lang then
  return tdcli.sendMessage(data.chat_id_, "", 0, "*Done*", 0, "md")
      elseif lang then
  ...
  return tdcli.sendMessage(data.chat_id_, "", 0, "Username Not True", 0, "md")
      end
   end
end
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    if not lang then
    return tdcli.sendMessage(arg.chat_id, "", 0, "*User* `not` *banned*", 0, "md")
   else
    return tdcli.sendMessage(arg.chat_id, "", 0, "_کاربر_ "..user_name.." *"..data.id_.."* *از گروه محروم نبود*", 0, "md")
      end
   end
...
tdcli.deleteMessagesFromUser(arg.chat_id, data.id_, dl_cb, nil)
   if not lang then
  return tdcli.sendMessage(arg.chat_id, "", 0, "*Done*", 0, "md")
      elseif lang then
...
tdcli.deleteMessagesFromUser(msg.to.id, matches[2], dl_cb, nil)
    if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "*Done*", 0, "md")
   elseif lang then
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
  return tdcli.sendMessage(msg.to.id, "", 0, "#Done *Member with :*\n*Username* : "..user_name.."\nid : *"..data.id_.."*\n*is globally banned*", 0, "md")
    else
...
kick_user(matches[2], msg.to.id)
   if not lang then
 return tdcli.sendMessage(msg.to.id, msg.id, 0, "#Done *Member with :*\n*Username* : "..user_name.."\nid : *"..data.id_.."*\n*Has Been globally banned*", 0, "md")
    else
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   if not is_gbanned(matches[2]) then
     if not lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "*User* `not` *globally banned*", 0, "md")
    else
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   if not lang then
   return tdcli.sendMessage(msg.to.id, "", 0, "*User* `not` *banned*", 0, "md")
  else
